...
<br><br><br><br>
			<table>
				...
				<tr>
					...
					<td>
					<fmt:formatNumber var="sum2" value="${a.item_price * onecnt }" pattern="#,###" />
					...
					<tr>
						...
						<td>소계</td>
								...
								<td>
								<fmt:formatNumber var="sum3" value="${a.item_price * onecnt }" pattern="#,###" />
					...
					<tr>
						...
						<td>총계</td>
							...
							<td><fmt:formatNumber var="sum3" value="${a.item_price * onecnt }" pattern="#,###" />
					<c:out value="₩${sum3}"></c:out></td>
