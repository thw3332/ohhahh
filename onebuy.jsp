...
<form method="get" action="onereceipt.do">

	<div id="checkTop">

    <a href="Checkout.do"><p>C&nbsp;H&nbsp;E&nbsp;C&nbsp;K&nbsp;O&nbsp;U&nbsp;T&nbsp;</p></a>
		...
		<div id="checkCenter_1">
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" placeholder="전화 또는 휴대폰" id="phone" value="${dto.phone}" name="phone"></td>
		...
		<div>
			...
			<table>
				...
				<tr>
					...
					<td>
					<fmt:formatNumber var="sum2" value="${a.item_price * cnt }" pattern="#,###" />
					...
					<tr>
						...
						<td>소계</td>
							...
							<td>
							<fmt:formatNumber var="sum3" value="${a.item_price * cnt }" pattern="#,###" />
					...
					<tr>
						...
						<td><fmt:formatNumber var="sum3" value="${a.item_price * cnt }" pattern="#,###" />
					<c:out value="₩${sum3}"></c:out>
</td>
