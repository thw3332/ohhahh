...
@WebServlet("/BoardComment2.do")
public class BoardComment2 extends HttpServlet {
	...
	protected void reqPro(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(logid=="" || logid==null || logid=="null" || logid=="손님") {
			session.setAttribute("msg", "로그인 후 댓글을 달 수 있습니다.");
