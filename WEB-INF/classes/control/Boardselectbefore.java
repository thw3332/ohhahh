...
/**
 * Servlet implementation class Boardselectbefore
 */
@WebServlet("/Boardselectbefore.do")
public class Boardselectbefore extends HttpServlet {
...
protected void reqpro(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	...
	int before_code = bdao.getOnebeforecode(a);
	System.out.println("before_code" + before_code);
	BoardDTO bdto= bdao.getOne(before_code);
