...
public class ShopDTO {
	...
	public int getRecent_item_code() {
		return recent_item_code;
	}
	public void setRecent_item_code(int recent_item_code) {
		this.recent_item_code = recent_item_code;
	}
	public String getId() {
		return id;
	}
